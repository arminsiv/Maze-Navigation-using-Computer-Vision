...
# CONFIGURATION
# ================================================================
INITIAL_HEADING = 0.0  # Robot starting direction (0°=East, 90°=North, 180°=West, 270°=South)
MOVEMENT_SCALE_CORRECTION = 0.85  # Reduce movement by 15% (robot moves too much)
...
async def navigate(robot):
    ...
    # Load waypoints
    waypoints = np.load("astar_path_simplified.npy")
